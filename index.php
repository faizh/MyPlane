												...
												<form action="cari.php" method="GET">
													<div class="row form-group">
														<div class="col-md-12">
															...
															<select class="form-control" name="asal" required="required">
													...
													<div class="row form-group">
														<div class="col-md-12">
															<h4>Kedatangan</h4>
															<select class="form-control" name="tujuan" required required="required">
																<!-- <option>Pilih Bandara</option> -->
																<?php 
													...
													<?php
														if ((isset($_SESSION['username']))&&($username!="root")) {
														   echo "<div class='row form-group'>
															...
															// echo "<li><a href='login.php'>Cari</a></li>";
														}
													?>
